...
//   const [downloadType, setDownloadType] = useState("pdf");
  ...
  useEffect(() => {
    // Fetch employee salary data from backend
  ...
  const generatePDF = () => {
    ...
    doc.setFontSize(18);
    doc.text("Employee Salary Report", 75, 50);

    // Add report details
    doc.setFontSize(12);
    doc.text(`Total Employees: ${salaryReportData.length}`, 10, 70); 
    ...
    doc.autoTable({
      ...
      body: salaryReportData.map((salary) => [
        salary.employeeName,
        salary.NIC,
        salary.formDate,
        salary.toDate,
    ...
    doc.text(
      "Employee Manager Signature: ____________________",
      10,
